...
export const SEED_ROWS: ContentRow[] = [
  {
    id: 'r1', date: 'Jul 2, 2026', title: 'Best Snacks for Kids’ Teeth', sourceType: 'topic',
  ...
  {
    id: 'r2', date: 'Jun 30, 2026', title: 'How to Help Kids Brush Better', sourceType: 'topic',
  ...
  {
    id: 'r3', date: 'Jul 3, 2026', title: 'Why Baby Teeth Matter', sourceType: 'url',
    sourceUrl: 'https://www.aapd.org/resources/parent/baby-teeth',
    platforms: ['Website', 'Instagram'], status: 'drafting',
    summary: '', script: '',
  },
  {
    id: 'r4', date: 'Jun 25, 2026', title: 'Thumb-Sucking: When to Worry', sourceType: 'outline',
  ...
  {
    id: 'r5', date: 'Jul 1, 2026', title: 'First Dental Visit Tips', sourceType: 'topic',
  ...
  {
    id: 'r6', date: 'Jul 4, 2026', title: 'Are Fluoride Treatments Safe for Kids?', sourceType: 'topic',
  ...
  {
    id: 'r7', date: 'Jul 3, 2026', title: 'What to Do When Your Child Knocks Out a Tooth', sourceType: 'topic',
  ...
  {
    id: 'r8', date: 'Jul 5, 2026', title: 'Pacifiers and Teeth: What Parents Should Know', sourceType: 'topic',
    topic: 'Pacifier use and dental development', platforms: ['Instagram'], status: 'intake', summary: '',
  },
  {
    id: 'r9', date: 'Jul 4, 2026', title: 'Handling Your Toddler’s First Cavity', sourceType: 'topic',
  ...
  {
    id: 'r10', date: 'Jul 2, 2026', title: 'Back-to-School Dental Checklist', sourceType: 'outline',
    outline: '- Book the checkup early\n- New toothbrush\n- Pack tooth-friendly lunches\n- Mouthguard for sports', platforms: ['Instagram', 'Website'], status: 'scheduled',
  ...
  {
    id: 'r11', date: 'Jun 30, 2026', title: 'How Often Should Kids Really Floss?', sourceType: 'topic',
  ...
  {
    id: 'r12', date: 'Jul 3, 2026', title: 'Teething 101 for New Parents', sourceType: 'topic',
    topic: 'Soothing a teething baby', platforms: ['Instagram', 'Website'], status: 'failed_video',
  ...
  {
    id: 'r13', date: 'Jul 5, 2026', title: 'Sports Mouthguards for Kids', sourceType: 'url',
    sourceUrl: 'https://www.aapd.org/resources/parent/mouthguards', platforms: ['Instagram', 'Website', 'YouTube'], status: 'failed_scrape',
